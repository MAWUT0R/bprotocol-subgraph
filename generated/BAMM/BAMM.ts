...
export class BAMM__getSwapEthAmountResult {
  value0: BigInt;
  value1: BigInt;
...
export class BAMM extends ethereum.SmartContract {
  static bind(address: Address): BAMM {
    return new BAMM("BAMM", address);
  }
  ...
  getSwapEthAmount(lusdQty: BigInt): BAMM__getSwapEthAmountResult {
    let result = super.call(
      "getSwapEthAmount",
    ...
    return new BAMM__getSwapEthAmountResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getSwapEthAmount(
    lusdQty: BigInt
  ): ethereum.CallResult<BAMM__getSwapEthAmountResult> {
    let result = super.tryCall(
      "getSwapEthAmount",
      "getSwapEthAmount(uint256):(uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(lusdQty)]
    ...
    return ethereum.CallResult.fromValue(
      new BAMM__getSwapEthAmountResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
